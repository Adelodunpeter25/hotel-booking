...
const BookingsTab = () => {
    ...
    const allBookings = [
        { id: '#UYB033312UAI', guest: 'John Doe', hotel: 'Grand Plaza Hotel', room: 'Super Deluxe Twin', checkin: '2025-11-05', checkout: '2025-11-08', amount: '$1,260.00', status: 'Confirmed' },
        { id: '#KDV075959L0D', guest: 'Jane Smith', hotel: 'Paradise Resort', room: 'Luxury Suite', checkin: '2025-11-10', checkout: '2025-11-12', amount: '$478.80', status: 'Pending' },
        { id: '#W0E045159B2T', guest: 'Mike Johnson', hotel: 'City Stay Inn', room: 'Superior Premium Room', checkin: '2025-11-15', checkout: '2025-11-18', amount: '$1,470.00', status: 'Confirmed' },
        { id: '#CQ9074830QAR', guest: 'Sarah Williams', hotel: 'Royal Palace Hotel', room: 'Balcony Executive Room', checkin: '2025-11-20', checkout: '2025-11-22', amount: '$210.00', status: 'Canceled' },
        { id: '#9760417094XE', guest: 'Tom Brown', hotel: 'Skyline Business Center', room: 'Superior Premium Room', checkin: '2025-11-25', checkout: '2025-11-27', amount: '$1,470.00', status: 'Confirmed' },
    ];
