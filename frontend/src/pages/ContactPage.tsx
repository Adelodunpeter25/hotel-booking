                        ...
                        >
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-lg">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">support@luxestay.com</p>
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-lg">
                                ...
                                <div className="flex space-x-4">
                                    <a href="#" className="bg-gray-900 hover:bg-black text-white w-10 h-10 rounded-full flex items-center justify-center transition">
